...
df = pd.read_csv("C:\MTech\Semester 3\Social Media Analytics\Assg 1\Tweets.csv")
df.head()

train_df = pd.read_csv("C:\MTech\Semester 3\Social Media Analytics\Assg 1\Tweets.csv")
train_df.head()
# data validation
valid_df = pd.read_csv("C:\MTech\Semester 3\Social Media Analytics\Assg 1\Tweets.csv")
valid_df.head()
